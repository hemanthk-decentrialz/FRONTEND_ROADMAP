...
export default function GoalsPage() {
  ...
  function increaseProgress(id: number) {
    setGoals((previousGoals) =>
  ...
  function decreaseProgress(id: number) {
    setGoals((previousGoals) =>
      previousGoals.map((goal) =>
        goal.id === id
          ? {
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        <div className="space-y-6 lg:col-span-2">
          {goals.length === 0 ? (
            ...
            goals.map((goal) => (
              <GoalCard key={goal.id} goal={goal} onIncrease={increaseProgress} onDecrease={decreaseProgress} onDelete={deleteGoal}/>
            ))
          )}
        </div>
      </div>
